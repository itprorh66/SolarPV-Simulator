...
#TODO  updarte get_load_profile to create AC & DC hourly load profiles
        ...
        for dfrw in range(self.get_row_count()):
            ...
            for h in range(24):
                if et < 24:
                    ...
                    if h >= st or h + 24 < et:
                        rslt[h] += hr_wts                      
#                if hpd == 24 or h >= st or (h + 24) < (hpd + st):
#                    rslt[h] += hr_wts
...
#        sl.add_new_row(['Light, Halogen', 10, 0.95, 5, 18, 35.0])
...
#        sl.add_new_row(['TV', 3, 0.9, 5, 16, 100.0])
